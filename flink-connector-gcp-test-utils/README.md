...
real-GCP gated tests, deadline-bounded polling/draining helpers, and the Pub/Sub test harness —
the emulator container image and admin/publish/pull clients parameterised over the transport
(emulator channel or application-default credentials).
