...
final class BigtableStagedWrites {
    private BigtableStagedWrites() {}

    static void configure(StreamExecutionEnvironment env, DataStream<OrderEvent> events) {
        // tag::bigtable-staged-writes[]
