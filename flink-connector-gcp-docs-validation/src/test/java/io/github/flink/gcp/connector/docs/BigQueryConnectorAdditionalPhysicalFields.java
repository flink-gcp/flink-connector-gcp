...
final class BigQueryConnectorAdditionalPhysicalFields {

    private BigQueryConnectorAdditionalPhysicalFields() {}
                ...
                BigQuerySink.<MyEvent>builder()
                        ...
                        .additionalFields(
                                AdditionalFields.<MyEvent>builder()
                                        ...
                                        .build())
                        .build();
        // end::bigquery-connector-additional-physical-fields[]
    }
}
