...
final class SpannerExamplesFixedTimestamp {

    private SpannerExamplesFixedTimestamp() {}

    static void build() {
        // tag::spanner-examples-fixed-timestamp[]
        ...
        SpannerSource.<Order>builder()
                ...
                .build();
        // end::spanner-examples-fixed-timestamp[]
    }
}
