...
final class BigQueryExamplesDebeziumMySqlCdc {

    private BigQueryExamplesDebeziumMySqlCdc() {}

    // tag::bigquery-debezium-mysql-cdc-kafka-source[]
    ...
    // end::bigquery-debezium-mysql-cdc-kafka-source[]
    ...
    static void runDataStream(
            ...
            throws Exception {
        // tag::bigquery-debezium-mysql-cdc-datastream[]
        ...
        env.execute("debezium-mysql-to-bigquery-cdc");
        // end::bigquery-debezium-mysql-cdc-datastream[]
    }
    ...
    static void registerSqlSource(
            ...
            KafkaSource<GenericRecord> kafkaSource) {
        // tag::bigquery-debezium-mysql-cdc-sql-bridge[]
        env.enableCheckpointing(60_000);
        ...
        // end::bigquery-debezium-mysql-cdc-sql-bridge[]
    }

    // tag::bigquery-debezium-mysql-cdc-adapter[]
    ...
    // end::bigquery-debezium-mysql-cdc-adapter[]
}
