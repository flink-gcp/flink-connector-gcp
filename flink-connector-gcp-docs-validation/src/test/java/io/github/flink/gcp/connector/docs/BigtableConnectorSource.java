...
final class BigtableConnectorSource {

    private BigtableConnectorSource() {}

    static Source<Order, ?, ?> build() {
        BigtableRowDeserializationSchema<Order> myDeserializer = new OrderRows();
        // tag::bigtable-connector-source[]
        Source<Order, ?, ?> source =
