...
final class BigtableExamplesApplicationProfile {

    private BigtableExamplesApplicationProfile() {}

    static void build() {
        // tag::bigtable-examples-application-profile[]
        BigtableSource.<Order>builder()
                ...
                .build();
        // end::bigtable-examples-application-profile[]
    }
}
