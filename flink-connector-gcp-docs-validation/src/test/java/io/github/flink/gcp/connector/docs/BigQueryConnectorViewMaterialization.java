...
final class BigQueryConnectorViewMaterialization {

    private BigQueryConnectorViewMaterialization() {}

    static void build(Schema schema) {
        // tag::bigquery-connector-view-materialization[]
        BigQuerySource.<GenericRecord>builder()
                ...
                .build();
        // end::bigquery-connector-view-materialization[]
    }
}
