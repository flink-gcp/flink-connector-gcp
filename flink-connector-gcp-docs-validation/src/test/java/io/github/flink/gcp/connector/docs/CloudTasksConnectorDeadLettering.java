...
final class CloudTasksConnectorDeadLettering {

    private CloudTasksConnectorDeadLettering() {}
    ...
    static void build() {
        ...
        // tag::cloud-tasks-connector-dead-lettering[]
                ...
                .failedTaskHandler(
                        FailureHandler.sendToDeadLetterQueue(
                                PubSubDeadLetterQueue.builder()
                                        ...
                                        .build()))
                .build();
        // end::cloud-tasks-connector-dead-lettering[]
    }
}
