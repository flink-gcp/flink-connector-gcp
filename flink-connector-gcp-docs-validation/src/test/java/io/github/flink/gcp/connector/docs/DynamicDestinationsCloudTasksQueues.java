...
final class DynamicDestinationsCloudTasksQueues {

    private DynamicDestinationsCloudTasksQueues() {}

    static void build() {
        // tag::cloud-tasks-queues[]
    ...
    private static final class OrderEvent {
        ...
        private OrderEvent(String customerId) {
