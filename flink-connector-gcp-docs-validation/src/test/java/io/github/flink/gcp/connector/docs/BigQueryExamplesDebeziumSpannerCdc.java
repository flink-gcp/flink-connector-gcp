...
import io.github.flink.gcp.connector.bigquery.sink.cdc.DebeziumSpannerCdcSequenceNumberProvider;
...
final class BigQueryExamplesDebeziumSpannerCdc {

    private BigQueryExamplesDebeziumSpannerCdc() {}

    // tag::bigquery-debezium-spanner-cdc-kafka-source[]
    ...
    // end::bigquery-debezium-spanner-cdc-kafka-source[]
    ...
    static void runDataStream(
            ...
            throws Exception {
        // tag::bigquery-debezium-spanner-cdc-datastream[]
        ...
        env.execute("debezium-spanner-to-bigquery-cdc");
        // end::bigquery-debezium-spanner-cdc-datastream[]
    }
    ...
    static void registerSqlSource(
            ...
            KafkaSource<GenericRecord> kafkaSource) {
        // tag::bigquery-debezium-spanner-cdc-sql-bridge[]
        env.enableCheckpointing(60_000);
        ...
        // end::bigquery-debezium-spanner-cdc-sql-bridge[]
    }

    // tag::bigquery-debezium-spanner-cdc-adapter[]
    ...
    // end::bigquery-debezium-spanner-cdc-adapter[]
}
