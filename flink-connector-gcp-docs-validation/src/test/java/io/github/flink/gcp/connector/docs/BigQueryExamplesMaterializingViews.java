...
final class BigQueryExamplesMaterializingViews {

    private BigQueryExamplesMaterializingViews() {}

    static void build(Schema readerSchema) {
        // tag::bigquery-examples-materializing-views[]
        BigQuerySource.<GenericRecord>builder()
                ...
                .build();
        // end::bigquery-examples-materializing-views[]
    }
}
