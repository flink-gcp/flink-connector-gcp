...
final class BigtableExamplesSeveralCellsAndDelete {

    private BigtableExamplesSeveralCellsAndDelete() {}

    static void build() {
        // tag::bigtable-examples-several-cells-and-delete[]
        BigtableSink.<OrderEvent>builder()
                ...
                .build();
        // end::bigtable-examples-several-cells-and-delete[]
    }
}
