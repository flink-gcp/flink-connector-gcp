...
final class BigtableExamplesEmulatorSource {

    private BigtableExamplesEmulatorSource() {}

    static void build() {
        // tag::bigtable-examples-emulator-source[]
        BigtableSource.<Order>builder()
                ...
                .build();
        // end::bigtable-examples-emulator-source[]
    }
}
