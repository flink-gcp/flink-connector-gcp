...
final class SpannerExamplesChangeStreamFilters {

    private SpannerExamplesChangeStreamFilters() {}

    static SpannerChangeStreamSource<OrderChange> build() {
        // tag::spanner-examples-change-stream-filters[]
        SpannerChangeStreamSource<OrderChange> source =
                SpannerChangeStreamSource.<OrderChange>builder()
                        ...
                        .build();
        // end::spanner-examples-change-stream-filters[]
        return source;
    }
}
