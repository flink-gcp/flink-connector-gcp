...
final class BigtableConnectorFailedMutationPolicy {

    private BigtableConnectorFailedMutationPolicy() {}

    static void build() {
        // tag::bigtable-connector-failed-mutation-policy[]
        BigtableSink.<OrderEvent>builder()
                ...
                .build();
        // end::bigtable-connector-failed-mutation-policy[]
    }
}
