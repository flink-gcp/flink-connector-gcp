...
| Page | Surface |
|---|---|
| [BigQuery]({{< relref "docs/reference/bigquery" >}}) | The source and sink builders, bounded table and query reads, the three write methods' options objects, experimental CDC writes and table provisioning, table creation and schema updates, and serializer schema options |
