...
| `deliveryGuarantee` | `AT_LEAST_ONCE` | Selects eager writes or experimental checkpoint-owned `EXACTLY_ONCE`; the latter still requires the Stage 2 acceptance tracked in [#1327]({{< param BookRepo >}}/issues/1327) before release |
