...
| `deliveryGuarantee` | `AT_LEAST_ONCE` | Selects eager writes or experimental checkpoint-owned `EXACTLY_ONCE`; the Stage 2 assessment declined the latter on 2026-09-21 under [#1327]({{< param BookRepo >}}/issues/1327), so it is not released or supported |
