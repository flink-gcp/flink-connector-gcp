...
| `heartbeatInterval` | `2 s` | Service heartbeat interval, from 1 second through 5 minutes. Heartbeats advance the coordinator's unfinished-ledger source watermark |
