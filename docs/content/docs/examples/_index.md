...
|---|---|---|---|
| BigQuery: [Quickstart]({{< relref "docs/quickstart/bigquery" >}}), DataStream [source]({{< relref "docs/examples/bigquery" >}}#datastream-source) and [sink]({{< relref "docs/examples/bigquery" >}}#datastream-sink), Table [source]({{< relref "docs/examples/bigquery" >}}#table-source) and [sink]({{< relref "docs/examples/bigquery" >}}#table-sink), [CDC]({{< relref "docs/examples/bigquery" >}}#change-data-capture), [local development]({{< relref "docs/examples/bigquery" >}}#local-development), [DataStream reference]({{< relref "docs/connectors/datastream/bigquery" >}}), [Table reference]({{< relref "docs/connectors/table/bigquery" >}}) | Analytics warehouse | Split bounded reads; dynamic table destinations; at-least-once or exactly-once service writes; CDC on the at-least-once default stream, Experimental ([#706]({{< param BookRepo >}}/issues/706)) | Bounded scan pushdown; insert sink; keyed CDC sink, Experimental ([#706]({{< param BookRepo >}}/issues/706)); sink-writable CDC sequence inputs |
