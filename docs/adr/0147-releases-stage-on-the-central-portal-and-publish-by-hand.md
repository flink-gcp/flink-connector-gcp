...
The pinned `softprops/action-gh-release` v3.0.3 first creates an ordinary release as a draft, uploads its assets, then applies `draft: false` when finalizing it.
