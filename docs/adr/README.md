...
| [0073](0073-bigtable-auto-creation-parks-not-found-and-repairs-through-an-ensure.md) | Bigtable auto-creation parks `NOT_FOUND` and repairs through an idempotent add-only ensure | Accepted | 2026-08-09 | [#233](https://github.com/laughingman7743/flink-connector-gcp/issues/233) | bigtable |
