...
| [0015](0015-everything-bundled-in-a-sql-uber-jar-is-relocated-and-its-notice-is-generated.md) | Everything bundled in a SQL uber-jar is relocated, and its NOTICE is generated and pinned | Accepted | 2026-07-27 | [#138](https://github.com/laughingman7743/flink-connector-gcp/issues/138), [#352](https://github.com/laughingman7743/flink-connector-gcp/issues/352) | all flink-sql-connector-gcp-* |
...
| [0022](0022-exactly-once-uses-buffered-streams-reused-across-checkpoints-never-finalized.md) | Exactly-once uses buffered streams reused across checkpoints, never finalized | Accepted | 2026-07-25 | [#30](https://github.com/laughingman7743/flink-connector-gcp/issues/30), [#76](https://github.com/laughingman7743/flink-connector-gcp/issues/76), [#77](https://github.com/laughingman7743/flink-connector-gcp/issues/77) | bigquery |
...
| [0032](0032-the-other-two-write-methods-map-unconditionally-and-the-factory-decides.md) | The other two write methods' mappers build unconditionally; the factory decides | Accepted | 2026-08-06 | [#288](https://github.com/laughingman7743/flink-connector-gcp/issues/288), [#332](https://github.com/laughingman7743/flink-connector-gcp/issues/332) | bigquery |
...
| [0034](0034-bigquery-sink-metrics-are-three-writer-classes-and-one-committer-counter.md) | BigQuery sink metrics are three writer classes and one committer counter | Accepted | 2026-08-03 | [#210](https://github.com/laughingman7743/flink-connector-gcp/issues/210), [#76](https://github.com/laughingman7743/flink-connector-gcp/issues/76), [#77](https://github.com/laughingman7743/flink-connector-gcp/issues/77) | bigquery |
...
| [0041](0041-the-bigtable-sink-is-implemented-on-four-checked-sdk-facts.md) | The Bigtable sink is implemented — not adopted or vendored — on four checked SDK facts | Accepted | 2026-08-02 | [#33](https://github.com/laughingman7743/flink-connector-gcp/issues/33), [#236](https://github.com/laughingman7743/flink-connector-gcp/issues/236) | bigtable |
...
| [0048](0048-the-cloud-tasks-sink-owns-its-retry-loop-and-never-creates-queues.md) | The Cloud Tasks sink owns its retry loop and never creates queues | Accepted | 2026-07-25; revised 2026-08-12 | [#23](https://github.com/laughingman7743/flink-connector-gcp/issues/23), [#24](https://github.com/laughingman7743/flink-connector-gcp/issues/24), [#545](https://github.com/laughingman7743/flink-connector-gcp/issues/545) | cloudtasks |
...
| [0052](0052-the-sinks-mailbox-waits-are-bounded-on-progress-not-on-the-call.md) | The Pub/Sub sink's mailbox waits are bounded on progress, not on the call | Accepted | 2026-08-07 | [#333](https://github.com/laughingman7743/flink-connector-gcp/issues/333) | pubsub |
...
| [0054](0054-flink-1-20-is-supported-from-the-same-source-tree-at-source-level.md) | Flink 1.20 is supported from the same source tree, at source level | Accepted | 2026-08-01 | [#32](https://github.com/laughingman7743/flink-connector-gcp/issues/32), [#404](https://github.com/laughingman7743/flink-connector-gcp/issues/404) | all connectors |
...
| [0059](0059-ci-yaml-orchestrates-pull-request-ci-behind-one-required-check.md) | `ci.yaml` orchestrates pull-request CI behind one required check, "CI passed" | Accepted | 2026-08-02 | [#250](https://github.com/laughingman7743/flink-connector-gcp/issues/250), [#444](https://github.com/laughingman7743/flink-connector-gcp/issues/444) | all (CI) |
...
| [0066](0066-a-paused-splits-buffer-is-bounded-by-parking-its-subscriber.md) | A paused split's buffer is bounded by parking its subscriber | Accepted | 2026-08-08 | [#357](https://github.com/laughingman7743/flink-connector-gcp/issues/357) | pubsub |
| [0067](0067-a-test-mints-an-sdk-owned-value-object-from-the-vendors-package.md) | A test mints an SDK-owned value object from a helper in the vendor's package | Accepted | 2026-08-08 | [#337](https://github.com/laughingman7743/flink-connector-gcp/issues/337) | bigquery (tests); rule is cross-connector |
| [0068](0068-duration-budgets-are-bounded-at-the-setter-by-what-a-nanosecond-clock-can-express.md) | A `Duration` budget is bounded at the setter by what a nanosecond clock can express | Accepted | 2026-08-08 | [#334](https://github.com/laughingman7743/flink-connector-gcp/issues/334), [#321](https://github.com/laughingman7743/flink-connector-gcp/issues/321), [#333](https://github.com/laughingman7743/flink-connector-gcp/issues/333), [#381](https://github.com/laughingman7743/flink-connector-gcp/issues/381), [#413](https://github.com/laughingman7743/flink-connector-gcp/issues/413) | base, pubsub, cloudtasks, bigtable, bigquery |
| [0069](0069-a-pr-branch-is-rebased-before-it-is-squashed.md) | A PR branch is rebased before it is squashed, and the deletion list is read before it is pushed | Accepted | 2026-08-08 | [#376](https://github.com/laughingman7743/flink-connector-gcp/pull/376) | all (workflow) |
| [0070](0070-the-staging-roll-threshold-is-a-measured-throughput-band-not-limit-arithmetic.md) | The FILE_LOADS staging roll threshold is a measured throughput band, not limit arithmetic | Accepted | 2026-08-08 | [#285](https://github.com/laughingman7743/flink-connector-gcp/issues/285), [#281](https://github.com/laughingman7743/flink-connector-gcp/issues/281) | bigquery |
| [0071](0071-a-lost-table-creation-race-is-retried-by-a-wrapped-table-admin.md) | A lost table-creation race is retried by a wrapped `TableAdmin`, and the REST verdict lives with the REST client | Accepted | 2026-08-08 | [#383](https://github.com/laughingman7743/flink-connector-gcp/issues/383) | bigquery |
| [0072](0072-parquet-staging-is-opt-in-batch-shaped-and-brings-its-own-dependencies.md) | Parquet staging is opt-in, batch-shaped, and brings its own dependencies | Accepted | 2026-08-08 | [#284](https://github.com/laughingman7743/flink-connector-gcp/issues/284), [#281](https://github.com/laughingman7743/flink-connector-gcp/issues/281) | bigquery |
| [0073](0073-bigtable-auto-creation-parks-not-found-and-repairs-through-an-ensure.md) | Bigtable auto-creation parks `NOT_FOUND` and repairs through an idempotent add-only ensure | Accepted | 2026-08-09 | [#233](https://github.com/laughingman7743/flink-connector-gcp/issues/233), [#414](https://github.com/laughingman7743/flink-connector-gcp/issues/414) | bigtable |
| [0074](0074-the-bigtable-writer-pools-a-batcher-per-table-over-a-client-per-instance.md) | The Bigtable writer pools a batcher per table over a client per instance | Accepted | 2026-08-09 | [#232](https://github.com/laughingman7743/flink-connector-gcp/issues/232) | bigtable |
| [0075](0075-the-spanner-sink-batch-writes-and-owns-the-whole-retry-loop.md) | The Spanner sink batch-writes one mutation per group and owns the whole retry loop | Accepted | 2026-08-09 | [#220](https://github.com/laughingman7743/flink-connector-gcp/issues/220), [#36](https://github.com/laughingman7743/flink-connector-gcp/issues/36) | spanner |
| [0076](0076-two-spanner-statuses-are-routed-and-a-request-failure-never-is.md) | Two Spanner statuses are always routed, constraint violations are the job's choice | Accepted | 2026-08-09 | [#220](https://github.com/laughingman7743/flink-connector-gcp/issues/220) | spanner |
| [0077](0077-batch-limits-are-counted-in-index-aware-cells-read-once-at-open.md) | Batch limits are counted in index-aware cells, read once when the writer opens | Accepted | 2026-08-09 | [#220](https://github.com/laughingman7743/flink-connector-gcp/issues/220) | spanner |
| [0078](0078-a-stalled-bigtable-wait-is-reported-rather-than-bounded.md) | A stalled Bigtable wait is reported rather than bounded | Accepted | 2026-08-09 | [#431](https://github.com/laughingman7743/flink-connector-gcp/issues/431) | bigtable |
| [0079](0079-the-bigquery-source-splits-by-read-stream-and-its-enumerator-keeps-no-ledger.md) | The BigQuery source splits by read stream, and its enumerator keeps no ledger | Accepted | 2026-08-09 | [#390](https://github.com/laughingman7743/flink-connector-gcp/issues/390), [#64](https://github.com/laughingman7743/flink-connector-gcp/issues/64) | bigquery |
| [0080](0080-the-bigtable-scan-source-splits-by-sampled-row-key-range.md) | The Bigtable scan source splits by sampled row-key range, and a checkpoint truncates the range | Accepted | 2026-08-09 | [#216](https://github.com/laughingman7743/flink-connector-gcp/issues/216) | bigtable |
| [0081](0081-emulator-transport-is-shared-by-channel-ownership-not-by-settings-type.md) | Emulator transport is shared by channel ownership, not by settings type | Accepted | 2026-08-10 | [#438](https://github.com/laughingman7743/flink-connector-gcp/issues/438) | base, bigquery, pubsub, cloudtasks |
| [0082](0082-the-bigtable-batch-knobs-are-bounded-flush-triggers-and-the-client-counts-mutations.md) | The Bigtable batch knobs are bounded flush triggers, and the client is what counts mutations | Accepted | 2026-08-10 | [#436](https://github.com/laughingman7743/flink-connector-gcp/issues/436) | bigtable |
| [0083](0083-the-pull-assignment-split-enumerator-is-one-base-class.md) | The pull-assignment split enumerator is one base class, parameterised by the planning step | Accepted | 2026-08-10 | [#452](https://github.com/laughingman7743/flink-connector-gcp/issues/452) | base, bigquery, bigtable |
| [0084](0084-the-bigquery-read-path-is-bounded-and-explained-and-the-clients-own-resumption-is-the-loop.md) | The BigQuery read path is bounded and explained, and the client's own resumption is the loop | Accepted | 2026-08-10 | [#391](https://github.com/laughingman7743/flink-connector-gcp/issues/391) | bigquery |
| [0085](0085-the-spanner-batch-source-splits-by-server-planned-partition.md) | The Spanner batch source splits by server-planned partition, and a partition is the unit of progress | Accepted | 2026-08-10 | [#221](https://github.com/laughingman7743/flink-connector-gcp/issues/221) | spanner |
| [0086](0086-the-bigtable-table-layer-maps-onto-the-builders-over-an-hbase-compatible-ddl.md) | The Bigtable table layer maps onto the builders over an HBase-compatible DDL | Superseded by ADR-0102 | 2026-08-10; revised 2026-08-11, 2026-08-12 | [#458](https://github.com/laughingman7743/flink-connector-gcp/issues/458), [#473](https://github.com/laughingman7743/flink-connector-gcp/issues/473), [#543](https://github.com/laughingman7743/flink-connector-gcp/issues/543) | bigtable |
| [0087](0087-a-query-source-runs-one-query-job-and-lets-the-caller-choose-where-its-result-lands.md) | A query source runs one query job, and the caller chooses where its result lands | Accepted | 2026-08-10 | [#392](https://github.com/laughingman7743/flink-connector-gcp/issues/392) | bigquery |
...
| [0092](0092-the-bigtable-table-source-serves-projection-as-a-family-filter.md) | The Bigtable table source serves projection as a family filter | Accepted | 2026-08-11 | [#459](https://github.com/laughingman7743/flink-connector-gcp/issues/459) | bigtable |
| [0093](0093-the-bigtable-sink-does-not-serialize-same-row-batch-entries.md) | The Bigtable sink does not serialize same-row batch entries | Accepted | 2026-08-11 | [#471](https://github.com/laughingman7743/flink-connector-gcp/issues/471) | bigtable |
| [0094](0094-change-stream-start-positions-resolve-once-and-restored-state-wins-until-it-expires.md) | Change-stream start positions resolve once, and restored state wins until it expires | Accepted | 2026-08-10 | [#492](https://github.com/laughingman7743/flink-connector-gcp/issues/492), [#35](https://github.com/laughingman7743/flink-connector-gcp/issues/35), [#222](https://github.com/laughingman7743/flink-connector-gcp/issues/222) | base, bigtable, spanner |
| [0095](0095-the-bigtable-lookup-source-is-row-key-only-and-flink-owns-its-caches.md) | The Bigtable lookup source is row-key-only, and Flink owns its caches | Accepted | 2026-08-11 | [#460](https://github.com/laughingman7743/flink-connector-gcp/issues/460) | bigtable |
| [0096](0096-the-spanner-table-sink-maps-ddl-rows-to-native-mutations.md) | The Spanner table sink maps DDL rows to native mutations | Accepted | 2026-08-11 (revised 2026-08-13) | [#502](https://github.com/laughingman7743/flink-connector-gcp/issues/502), [#544](https://github.com/laughingman7743/flink-connector-gcp/issues/544) | spanner |
| [0097](0097-the-bigtable-change-stream-coordinator-checkpoints-the-partition-ledger.md) | The Bigtable Change Streams coordinator checkpoints the partition ledger | Accepted | 2026-08-11 | [#35](https://github.com/laughingman7743/flink-connector-gcp/issues/35), [#510](https://github.com/laughingman7743/flink-connector-gcp/issues/510) | bigtable |
| [0098](0098-the-spanner-lookup-source-is-primary-key-only-and-flink-owns-its-cache.md) | The Spanner lookup source is primary-key-only and Flink owns its cache | Accepted | 2026-08-11 | [#504](https://github.com/laughingman7743/flink-connector-gcp/issues/504) | spanner |
| [0099](0099-the-spanner-change-stream-coordinator-checkpoints-partition-lineage.md) | The Spanner Change Streams coordinator checkpoints partition lineage | Accepted | 2026-08-12 (revised 2026-08-13) | [#222](https://github.com/laughingman7743/flink-connector-gcp/issues/222), [#534](https://github.com/laughingman7743/flink-connector-gcp/issues/534), [#535](https://github.com/laughingman7743/flink-connector-gcp/issues/535), [#635](https://github.com/laughingman7743/flink-connector-gcp/issues/635) | base, spanner |
| [0100](0100-the-bigquery-table-source-maps-ddl-rows-onto-the-bounded-source.md) | The BigQuery table source maps DDL rows onto the bounded source | Accepted | 2026-08-12 | [#542](https://github.com/laughingman7743/flink-connector-gcp/issues/542) | bigquery |
| [0101](0101-the-spanner-change-stream-reader-bounds-asynchronous-partition-queries.md) | The Spanner Change Streams reader bounds asynchronous partition queries | Accepted | 2026-08-12 (revised 2026-08-13) | [#222](https://github.com/laughingman7743/flink-connector-gcp/issues/222), [#536](https://github.com/laughingman7743/flink-connector-gcp/issues/536), [#551](https://github.com/laughingman7743/flink-connector-gcp/issues/551), [#554](https://github.com/laughingman7743/flink-connector-gcp/issues/554), [#581](https://github.com/laughingman7743/flink-connector-gcp/issues/581), [#635](https://github.com/laughingman7743/flink-connector-gcp/issues/635) | spanner |
| [0102](0102-the-bigtable-table-sink-defaults-insert-only-input-to-upsert-with-a-compatibility-mode.md) | The Bigtable table sink defaults insert-only input to upsert with a compatibility mode | Accepted | 2026-08-12 | [#496](https://github.com/laughingman7743/flink-connector-gcp/issues/496) | bigtable |
| [0103](0103-the-bigtable-change-stream-reader-bounds-asynchronous-partition-reads.md) | The Bigtable Change Streams reader bounds asynchronous partition reads | Accepted | 2026-08-13 | [#553](https://github.com/laughingman7743/flink-connector-gcp/issues/553) | bigtable |
| [0104](0104-exactly-once-modes-use-service-native-replay-protection-and-pass-a-performance-gate.md) | Exactly-once modes use service-native replay protection and pass a performance gate | Accepted | 2026-08-13 | [#591](https://github.com/laughingman7743/flink-connector-gcp/issues/591) | bigquery, pubsub, cloudtasks, bigtable, spanner |
| [0105](0105-the-spanner-table-change-stream-source-emits-full-or-keyed-changelogs.md) | The Spanner table Change Stream source emits full or keyed changelogs | Accepted | 2026-08-13 | [#582](https://github.com/laughingman7743/flink-connector-gcp/issues/582), [#583](https://github.com/laughingman7743/flink-connector-gcp/issues/583) (under [#225](https://github.com/laughingman7743/flink-connector-gcp/issues/225)), [#635](https://github.com/laughingman7743/flink-connector-gcp/issues/635) | spanner |
| [0106](0106-the-bigtable-table-change-stream-is-an-insert-only-mutation-envelope.md) | The Bigtable table change stream preserves mutations or decodes one complete cell | Accepted | 2026-08-13 | [#523](https://github.com/laughingman7743/flink-connector-gcp/issues/523), [#600](https://github.com/laughingman7743/flink-connector-gcp/issues/600), [#603](https://github.com/laughingman7743/flink-connector-gcp/issues/603) | bigtable |
| [0107](0107-the-cloud-tasks-table-sink-separates-the-body-format-from-http-metadata.md) | The Cloud Tasks table sink separates the body format from HTTP metadata | Accepted | 2026-08-13 | [#99](https://github.com/laughingman7743/flink-connector-gcp/issues/99), [#605](https://github.com/laughingman7743/flink-connector-gcp/issues/605), [#606](https://github.com/laughingman7743/flink-connector-gcp/issues/606) | cloudtasks |
| [0108](0108-a-source-deserializer-collector-forwards-records-directly-on-the-task-thread.md) | A source deserializer collector forwards records directly on the task thread | Accepted | 2026-08-13 | [#587](https://github.com/laughingman7743/flink-connector-gcp/issues/587) | base, bigquery, pubsub, bigtable, spanner |
| [0109](0109-bigtable-change-stream-estimates-do-not-become-native-source-watermarks.md) | Bigtable Change Streams estimates do not become native source watermarks | Accepted | 2026-08-13 | [#604](https://github.com/laughingman7743/flink-connector-gcp/issues/604) | bigtable |
