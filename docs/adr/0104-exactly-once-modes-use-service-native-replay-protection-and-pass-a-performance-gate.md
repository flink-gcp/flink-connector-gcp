...
[ADR-0166](0166-bigtable-implementation-precedes-final-stage2-acceptance.md) permits Bigtable implementation before final Stage 2 acceptance; release and supported-workload claims still require that acceptance.
...
For candidates other than Cloud Tasks and Bigtable under ADR-0166, passing Stage 1 permits Stage 2 measurement, not implementation; ADR-0162 moves Cloud Tasks performance acceptance to the implemented mode's assessment in [#1246](https://github.com/flink-gcp/flink-connector-gcp/issues/1246).
