...
The [Stage 2 protocol](evidence/0163-bigtable-staged-performance-protocol.md) covers the complete cost required before release; ADR-0166 supersedes only its ordering before implementation.
