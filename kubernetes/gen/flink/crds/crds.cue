...
objects: {
	"flinkbluegreendeployments.flink.apache.org": {
		...
		metadata: name: "flinkbluegreendeployments.flink.apache.org"
		spec: {
			...
			versions: [{
				...
				schema: openAPIV3Schema: {
					properties: {
									...
									properties: {
										metadata: {
											properties: {
												...
												finalizers: {items: type: "string", type: "array"}
										...
										spec: {
											properties: {
												flinkConfiguration: "x-kubernetes-preserve-unknown-fields": true
												flinkVersion: {
													enum: ["v1_13", "v1_14", "v1_15", "v1_16", "v1_17", "v1_18", "v1_19", "v1_20", "v2_0", "v2_1", "v2_2"]
													type: "string"
												}
												image: type:           "string"
												...
												job: {
													properties: {
														...
														autoscalerResetNonce: type:   "integer"
														checkpointTriggerNonce: type: "integer"
														entryClass: type:             "string"
														initialSavepointPath: type:   "string"
														jarURI: type:                 "string"
														parallelism: type:            "integer"
														savepointRedeployNonce: type: "integer"
														savepointTriggerNonce: type:  "integer"
														state: {
															enum: ["running", "suspended"]
															type: "string"
														}
														upgradeMode: {
															enum: ["last-state", "savepoint", "stateless"]
															type: "string"
														}
													}
													type: "object"
																	...
																	properties: {
																								...
																								properties: {
																									podAffinityTerm: {
																										properties: {
																											...
																											matchLabelKeys: {items: type: "string", type: "array"}
																											mismatchLabelKeys: {items: type: "string", type: "array"}
																											namespaceSelector: {
																												properties: {
																													matchExpressions: {
																														items: {
																											...
																											namespaces: {items: type: "string", type: "array"}
																						...
																						properties: {
																							...
																							capabilities: {
																								properties: {
																									...
																									drop: {items: type: "string", type: "array"}
																								}
																								type: "object"
																							}
																		...
																		dnsConfig: {
																			properties: {
																				...
																				searches: {items: type: "string", type: "array"}
																			}
																			type: "object"
																		}
																		...
																		hostAliases: {
																			items: {
																				properties: {
																					hostnames: {items: type: "string", type: "array"}
																					ip: type: "string"
																				}
																				type: "object"
																			}
																		...
																		securityContext: {
																			properties: {
																				...
																				supplementalGroups: {items: type: "integer", type: "array"}
																		...
																		volumes: {
																			items: {
																				properties: {
																					...
																					cephfs: {
																						properties: {
																							monitors: {items: type: "string", type: "array"}
																							path: type:       "string"
																							readOnly: type:   "boolean"
																					...
																					ephemeral: {
																						properties: volumeClaimTemplate: {
																							properties: {
																								...
																								spec: {
																									properties: {
																										accessModes: {items: type: "string", type: "array"}
																										dataSource: {
																											properties: {
																					...
																					fc: {
																						properties: {
																							...
																							lun: type:      "integer"
																							readOnly: type: "boolean"
																							targetWWNs: {items: type: "string", type: "array"}
																							wwids: {items: type: "string", type: "array"}
																						}
																						type: "object"
																					}
																					flexVolume: {
																					...
																					iscsi: {
																						properties: {
																							...
																							lun: type:               "integer"
																							portals: {items: type: "string", type: "array"}
																							readOnly: type: "boolean"
																							secretRef: {
																								properties: name: type: "string"
																								type: "object"
																			...
																			items: {
																				properties: {
																					...
																					lastState: {
																						properties: {
																							running: {
																								properties: startedAt: type: "string"
																								type: "object"
																							}
																							terminated: {
																								properties: {
						...
						status: {
							properties: {
								abortTimestamp: type: "string"
								blueGreenState: {
									enum: ["ACTIVE_BLUE", "ACTIVE_GREEN", "INITIALIZING_BLUE", "SAVEPOINTING_BLUE", "SAVEPOINTING_GREEN", "TRANSITIONING_TO_BLUE", "TRANSITIONING_TO_GREEN"]
									type: "string"
								}
								deploymentReadyTimestamp: type: "string"
								error: type:                    "string"
								jobStatus: {
									properties: {
										checkpointInfo: {
											properties: {
												...
												lastCheckpoint: {
													properties: {
														...
														triggerNonce: type: "integer"
														triggerType: {
															enum: ["MANUAL", "PERIODIC", "UNKNOWN", "UPGRADE"]
															type: "string"
														}
													}
													type: "object"
												}
												lastPeriodicCheckpointTimestamp: type: "integer"
												triggerId: type:                       "string"
												triggerTimestamp: type:                "integer"
												triggerType: {
													enum: ["MANUAL", "PERIODIC", "UNKNOWN", "UPGRADE"]
													type: "string"
												}
										...
										savepointInfo: {
											properties: {
												formatType: {
													enum: ["CANONICAL", "NATIVE", "UNKNOWN"]
													type: "string"
												}
												lastPeriodicSavepointTimestamp: type: "integer"
												lastSavepoint: {
													properties: {
														formatType: {
															enum: ["CANONICAL", "NATIVE", "UNKNOWN"]
										...
										startTime: type: "string"
										state: {
											enum: ["CANCELED", "CANCELLING", "CREATED", "FAILED", "FAILING", "FINISHED", "INITIALIZING", "RECONCILING", "RESTARTING", "RUNNING", "SUSPENDED"]
											type: "string"
										}
										updateTime: type:           "string"
										upgradeSavepointPath: type: "string"
									}
									type: "object"
								}
								lastReconciledSpec: type:      "string"
								lastReconciledTimestamp: type: "string"
								savepointTriggerId: type:      "string"
							}
							type: "object"
						}
					}
	...
	"flinkdeployments.flink.apache.org": {
		apiVersion: "apiextensions.k8s.io/v1"
		kind:       "CustomResourceDefinition"
		metadata: name: "flinkdeployments.flink.apache.org"
		spec: {
			group: "flink.apache.org"
			names: {
			...
			versions: [{
				additionalPrinterColumns: [{
					...
					description: "Lifecycle state of the Flink resource (including being rolled back, failed etc.)."
						...
						status: {
							properties: {
								...
								jobManagerDeploymentStatus: {
									enum: ["DEPLOYED_NOT_READY", "DEPLOYING", "ERROR", "MISSING", "READY"]
									type: "string"
								}
								jobStatus: {
									properties: {
								...
								lifecycleState: {
									enum: ["CREATED", "DELETED", "DELETING", "DEPLOYED", "FAILED", "ROLLED_BACK", "ROLLING_BACK", "STABLE", "SUSPENDED", "UPGRADING"]
									type: "string"
								}
								observedGeneration: type: "integer"
								reconciliationStatus: {
									properties: {
										lastReconciledSpec: type:      "string"
										lastStableSpec: type:          "string"
										reconciliationTimestamp: type: "integer"
										state: {
											enum: ["DEPLOYED", "ROLLED_BACK", "ROLLING_BACK", "UPGRADING"]
											type: "string"
										}
									}
									type: "object"
	...
	"flinksessionjobs.flink.apache.org": {
		apiVersion: "apiextensions.k8s.io/v1"
		kind:       "CustomResourceDefinition"
		metadata: name: "flinksessionjobs.flink.apache.org"
		spec: {
			group: "flink.apache.org"
			names: {
	...
	"flinkstatesnapshots.flink.apache.org": {
		apiVersion: "apiextensions.k8s.io/v1"
		kind:       "CustomResourceDefinition"
		metadata: name: "flinkstatesnapshots.flink.apache.org"
		spec: {
			group: "flink.apache.org"
			names: {
					...
					properties: {
						spec: {
							properties: {
								...
								jobReference: {
									properties: {
										kind: {
											enum: ["FlinkDeployment", "FlinkSessionJob"]
											type: "string"
										}
										name: type: "string"
									}
						...
						status: {
							properties: {
								...
								path: type:            "string"
								resultTimestamp: type: "string"
								state: {
									enum: ["ABANDONED", "COMPLETED", "FAILED", "IN_PROGRESS", "TRIGGER_PENDING"]
									type: "string"
								}
								triggerId: type:        "string"
