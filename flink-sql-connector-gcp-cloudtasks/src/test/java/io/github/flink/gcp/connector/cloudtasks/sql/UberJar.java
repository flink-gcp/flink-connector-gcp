...
final class UberJar {
    ...
    static final ShadedJar SHADED =
            ShadedJar.of(
                    ...
                    "io/github/flink/gcp/connector/cloudtasks/shaded/");

    static final String FACTORY_CLASS =
            "io.github.flink.gcp.connector.cloudtasks.table.CloudTasksDynamicTableFactory";

    /**
     * A floor below which a parsed artifact list is assumed to be a parsing failure rather than a
     * real bundle; the tree holds 50 today. Set a little below that: it exists to catch "the regex
