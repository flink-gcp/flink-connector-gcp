...
class SpannerSplitReaderMemoryBoundaryTest {
    ...
    void defaultByteTargetCompletesWideRowsWithA192MiBHeap() throws Exception {
        ...
        Process process =
                new ProcessBuilder(
                                ...
                                "-cp",
                                classpath,
                                SpannerSplitReaderMemoryProbe.class.getName())
        ...
        assertThat(output).contains("PASS rows=768 maxBatchRows=47 heldBatches=4");
    }
}
