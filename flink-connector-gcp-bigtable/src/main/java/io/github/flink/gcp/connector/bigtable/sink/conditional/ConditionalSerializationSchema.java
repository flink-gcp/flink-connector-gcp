...
/**
 * Builds a conditional request. Returning null skips an input: no RPC, output or failure callback.
 *
 * @param <T> the input type
 */
@PublicEvolving
@FunctionalInterface
public interface ConditionalSerializationSchema<T> extends Serializable {
    /**
     ...
     */
    @Nullable
    ConditionalRequest serialize(T element, @Nullable SinkWriter.Context context)
            throws IOException;
}
