...
/**
 * Builder for {@link BigtableReadModifyWriteSink}.
 *
 * @param <T> the input type
 */
@PublicEvolving
public final class BigtableReadModifyWriteSinkBuilder<T> {
    ...
    BigtableReadModifyWriteSinkBuilder() {}
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> table(TableDestination table) {
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> destinationResolver(
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> serializer(
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> appProfileId(String appProfileId) {
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> requestOptions(
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> serviceAccountKeyFile(
     ...
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> emulatorEndpoint(
    ...
    /**
     * Handles row-level failures; ambiguous outcomes always fail the job.
     *
     * @param failedRequestHandler the handler
     * @return this builder
     */
    public BigtableReadModifyWriteSinkBuilder<T> failedRequestHandler(
     ...
     * @return the sink
     */
    public BigtableReadModifyWriteSink<T> build() {
