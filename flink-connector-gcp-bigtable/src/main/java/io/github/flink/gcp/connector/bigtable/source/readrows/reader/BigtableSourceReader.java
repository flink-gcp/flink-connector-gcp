 ...
 */
@Internal
public class BigtableSourceReader<T>
        extends SingleThreadMultiplexSourceReaderBase<Row, T, RowRangeSplit, RowRangeSplitState> {
     ...
     * @param recordEmitter deserializes rows and advances the split state
     * @param config the Flink configuration
     * @param context the reader context
     * @param opener the stream opener this reader owns and closes; the split readers share it
     */
    public BigtableSourceReader(
            Supplier<SplitReader<Row, RowRangeSplit>> splitReaderSupplier,
            RecordEmitter<Row, T, RowRangeSplitState> recordEmitter,
    ...
    @Override
    protected RowRangeSplitState initializedState(RowRangeSplit split) {
        return new RowRangeSplitState(split);
    }

    @Override
    protected RowRangeSplit toSplitType(String splitId, RowRangeSplitState splitState) {
        return splitState.toSplit();
    }

    @Override
    protected void onSplitFinished(Map<String, RowRangeSplitState> finishedSplits) {
        context.sendSplitRequest();
    }
