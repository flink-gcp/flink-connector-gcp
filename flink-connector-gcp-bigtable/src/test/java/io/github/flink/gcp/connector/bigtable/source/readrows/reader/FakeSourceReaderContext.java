 ...
 *
 * <p>Split requests are counted rather than refused, because asking for the next split is how this
 * source's reader gets work — the coordinator-facing methods it does not use still throw, so the
 * first test that needs one has to revisit this fake.
 */
final class FakeSourceReaderContext implements SourceReaderContext {
    ...
    public void sendSourceEventToCoordinator(SourceEvent sourceEvent) {
        throw new UnsupportedOperationException(
                "The Bigtable source sends no source events; add support here when it does.");
    }
