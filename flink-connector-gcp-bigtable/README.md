...
| Checkpoint-owned row mutations with retained replay markers | Experimental implementation ([#1211](https://github.com/flink-gcp/flink-connector-gcp/issues/1211)); final service recovery and Stage 2 acceptance pending ([#1319](https://github.com/flink-gcp/flink-connector-gcp/issues/1319)) |
