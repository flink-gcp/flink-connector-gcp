 ...
 */
@Internal
public final class StorageApiBufferedStreamService implements BufferedStreamService {
     ...
     */
    public StorageApiBufferedStreamService(@Nullable String location) throws IOException {
     ...
     */
    @VisibleForTesting
    public StorageApiBufferedStreamService(BigQueryWriteClient client, @Nullable String location) {
        this.client = client;
