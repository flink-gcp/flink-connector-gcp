...
import io.github.flink.gcp.connector.bigquery.sink.storageapi.committer.BufferedStreamCommitter;
import io.github.flink.gcp.connector.bigquery.sink.storageapi.writer.BigQueryBufferedStreamWriter;
import io.github.flink.gcp.connector.bigquery.sink.storageapi.writer.BufferedStreamServiceFactory;
import io.github.flink.gcp.connector.bigquery.sink.storageapi.writer.BufferedStreamWriterState;
import io.github.flink.gcp.connector.bigquery.sink.storageapi.writer.BufferedStreamWriterStateSerializer;
import io.github.flink.gcp.connector.bigquery.sink.storageapi.writer.StorageApiBufferedStreamServiceFactory;
...
public class BigQueryBufferedStreamSink<T>
    ...
    public BigQueryBufferedStreamSink(BigQuerySinkConfig<T> config, BufferedStreamOptions options) {
        this(config, options, new StorageApiBufferedStreamServiceFactory());
    }
    ...
    public Committer<BufferedStreamCommittable> createCommitter(CommitterInitContext context) {
        return new BufferedStreamCommitter(serviceFactory, config.getLocation());
    }
