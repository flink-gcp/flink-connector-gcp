...
/**
 * Smoke test of the production {@link StorageApiBufferedStreamService} wiring against the BigQuery
                        ...
                        BigQueryWriteSettings.newBuilder()
                                ...
                                .setTransportChannelProvider(
                                        InstantiatingGrpcChannelProvider.newBuilder()
                                                ...
                                                .build())
                                .build());
        try (BufferedStreamService service = new StorageApiBufferedStreamService(client, null)) {
